...
<div id="app-navigation">
	<?php if (!empty($_['forms']['admin'])): ?>
		<div id="app-navigation-caption-personal" class="app-navigation-caption-personal"><?php p($l->t('Personal')); ?></div>
	<?php endif; ?>
	...
	<?php if (!empty($_['forms']['admin'])): ?>
		<div id="app-navigation-caption-administration" class="app-navigation-caption-administration"><?php p($l->t('Administration')); ?></div>
	<?php endif; ?>
